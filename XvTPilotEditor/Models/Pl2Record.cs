...
namespace XvTPilotEditor.Models
{
    public class Pl2Record : PilotRecordBase
    {
        ...
        public void FillFromPl2(PL2FileRecord pl2File)
        {
            ...
            TotalFullKillsByPlayerRating    = new MissionCategoryRecordByPlayerRating(pl2File.TotalFullKillsOnPlayerRank);
            TotalSharedKillsByPlayerRating  = new MissionCategoryRecordByPlayerRating(pl2File.TotalSharedKillsOnPlayerRank);
            TotalAssistsByPlayerRating      = new MissionCategoryRecordByPlayerRating(pl2File.TotalAssistKillsOnPlayerRank);
            TotalFullKillsByAIRank          = new MissionCategoryRecordByAIRating(pl2File.TotalFullKillsOnAIRank);
            TotalSharedKillsByAIRank        = new MissionCategoryRecordByAIRating(pl2File.TotalSharedKillsOnAIRank);
            TotalAssistsByAIRank            = new MissionCategoryRecordByAIRating(pl2File.TotalAssistKillsOnAIRank);
            ...
            TotalLossesByPlayerRating       = new MissionCategoryRecordByPlayerRating(pl2File.TotalLossesFromPlayerRank);
            TotalLossesByAIRank             = new MissionCategoryRecordByAIRating(pl2File.TotalLossesFromAIRank);
